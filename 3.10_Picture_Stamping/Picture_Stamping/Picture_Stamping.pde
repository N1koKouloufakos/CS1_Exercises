...
color doggo_color = color(78, 52, 46);;
float doggo_x;
float doggo_y;
...
void keyPressed() 
{
  ...
  case '1':
    doggo_color = color(78, 52, 46);
    break;
  case '2':
    doggo_color = color(96, 125, 139);
   break;
  case '3':
     doggo_color = color(255, 224, 130);
   break;
  case ' ':
    doggo_x = random(0.5*doggo_diameter, width-0.5*doggo_diameter);
    doggo_y = random(0.5*doggo_diameter, height-0.5*doggo_diameter);
    draw_doggo(doggo_x, doggo_y, doggo_diameter, doggo_color);
    break;
  }
